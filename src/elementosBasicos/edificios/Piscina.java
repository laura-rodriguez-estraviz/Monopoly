...
final public class Piscina extends Edificio {//final porque no hay ninguna clase que herede de esta
    public Piscina(String id, Propiedad propiedad) {
        super(id, propiedad);
    }
    public String toString() {
        return "{\nid: " + this.getId() + "\n" +
                ...
                "coste: " + ((Solar)this.getPropiedad()).getValorPiscina() + "\n}";
    }
}
